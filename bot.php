...
if(!file_exists('config.json')){
	$token = readline('-Hi HUNTER AMEER Enter Token: ');
	$id = readline('-Hi HUNTER AMEER Enter Id: ');
		...
		if($update != null){
          ...
          $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              'video'=>"https://t.me/TEXT_PHP/1",
                   'caption'=>'𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝐻𝐸𝐿𝐿 𝐻𝑈𝑁𝑇𝐸𝑅 𝑨𝑴𝑬𝑬𝑹 
~ @CC_CCA 🍂',
		    ...
		    $bot->sendMessage([
		       'chat_id'=>$chatId,
                'message_id'=>$mid,
                'text'=>"𝙷𝙸 𝙱𝚁𝙾 𝙸𝙽 𝚃𝙷𝙴 𝙲𝙾𝙽𝚃𝚁𝙾𝙻 𝙱𝚈 ~ @CC_CCA",
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
...
https://t.me/a011437/6',
          	...
          	if($config['mode'] != null){
                ...
                'reply_markup'=>json_encode([
					...
					$bot->sendvideo([
       'chat_id'=>$chatId,
       'video'=> "https://t.me/CC_CCA/5",
        'caption'=>'البوت مدفوع 💲 و ليس مجاني 👁‍🗨
لشراء نسخه مراسلة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/CC_CCA']],
                       [['text'=>"▪️| قناة المطور الرسمي", 'url'=>"t.me/aMeEr_php"]],
                  ]
							])
					]);
				}
          ...
          if($data == 'login'){
            ...
            exec('screen -dmS gr php explore.php');
              ...
              $bot->sendMessage([
                'chat_id'=>$chatId,
                'text'=>"🎣 - تم بدأ الصيد 𖡦-› بـرعايـة @CC_CCA 
